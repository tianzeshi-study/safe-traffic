% safe-traffic(SECTION) | User Commands
%
% "July  8 2025"
...
safe-traffic - program to do something

# SYNOPSIS

**safe-traffic** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**safe-traffic** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **safe-traffic** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**safe-traffic** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    safe-traffic. See **foo.conf**(5) for further details.
...
**safe-traffic** provides some return codes, that can be used in scripts:
...
root <tianzeshi_study@outlook.com>
